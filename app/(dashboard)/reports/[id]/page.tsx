  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-8 py-12 print:px-0 print:py-0">
        ...
        <Collapsible className="mb-6 print:hidden">
          <CollapsibleTrigger className="flex w-full items-center justify-between rounded-lg border border-border bg-muted/30 px-4 py-3 text-left text-sm transition-colors hover:bg-muted/50 group">
            <div className="flex items-center gap-2">
              <Info className="h-4 w-4 text-muted-foreground" />
              <span className="font-medium text-foreground">How this report was generated</span>
            </div>
            <ChevronDown className="h-4 w-4 text-muted-foreground transition-transform group-data-[state=open]:rotate-180" />
          </CollapsibleTrigger>
          <CollapsibleContent className="mt-2 rounded-lg border border-border bg-muted/20 px-4 py-3 text-sm text-muted-foreground">
            <p>
              This report was generated by a <strong className="text-foreground">5-step durable pipeline</strong>.
              AlphaGenome (Google DeepMind) predicted functional effects from raw DNA sequence — this is
              not available in existing clinical tools like Varsome or Franklin. Claude applied ACMG/AMP 2015
              classification criteria. The pipeline ran on <strong className="text-foreground">Vercel WDK</strong>,
              meaning every step was checkpointed — a crash at any point resumes from that exact step rather
              than restarting.
            </p>
            <p className="mt-2">
              <strong className="text-foreground">AlphaGenome scores</strong> represent peak log-fold-change in
              RNA expression across tissues. Scores above <strong className="text-foreground">0.5</strong> contribute
              PP3 evidence to ACMG classification. Scores above <strong className="text-foreground">1.5</strong> contribute
              PS3 evidence.
            </p>
            <p className="mt-2 font-mono text-xs">
              Workflow ID: <span className="text-foreground">{caseData.workflow_id}</span>
            </p>
          </CollapsibleContent>
        </Collapsible>
        ...
        <section className="mb-8">
          ...
          <div className="rounded-lg border border-border bg-muted/20 p-4 text-sm text-foreground">
            ...
            <p className="mt-3 font-medium text-foreground">
              Pipeline Performance: Total duration {(pipelineTimeMs / 1000).toFixed(1)}s across 5 durable steps.
            </p>
          </div>
        </section>
        ...
        <footer className="border-t border-border pt-8">
          ...
          <div className="mt-8 rounded-lg border border-vus/30 bg-vus/5 p-4 text-xs text-vus">
            ...
            <p className="mt-1">
              This tool was built for educational and demonstration purposes at a hackathon. It is not 
              a certified IVD (in vitro diagnostic) device, has not been validated for clinical use, and 
              should not be used to make medical decisions. AlphaGenome predictions are research-grade. 
              Claude-generated ACMG classifications have not been reviewed by a board-certified clinical 
              geneticist. All patient names in this demo are fictional. No real patient data was used in 
              development.
            </p>
          </div>
        </footer>
